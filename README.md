...
To build the final jar and optimize the rfidMongodb application for production, run:
...
Then navigate to [http://localhost:9190](http://localhost:9190) in your browser.
