...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMAGECOLLECTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMAGECOLLECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMAGECOLLECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMAGECOLLECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMAGECOLLECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMAGECOLLECTION actions', async () => {
      const expectedActions = [
        {
